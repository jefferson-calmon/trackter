import { BrowserEngineType } from '../../types/bot'
import { getBrowserEngineType, isChromium86OrNewer } from '../../utils/browser'
...
export default function getLanguages(): string[][] {
  ...
  if (Array.isArray(n.languages)) {
    ...
    if (!(browserEngine === BrowserEngineType.Chromium && isChromium86OrNewer())) {
